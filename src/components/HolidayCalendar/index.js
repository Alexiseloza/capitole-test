...
class HolidayCalendar extends Component {
    constructor() {
        ...
        this.state = {
            name: 'No Holiday Today/ Ups Hoy no es feridado!',
            listOfHolidays : [],
            listOfDates : [],
            todaysDate: "2020-02-29",
            isTodayHoliday: false,
            indexOfHoliday: null,
            passed: false,

            modalState: false,
            holidayDate:"20-01-01",
    ...
    getListOfHolidays = async  () => {
         const response = await fetch(`https://calendarific.com/api/v2/holidays?api_key=16b495d8908f321dfe494c305733d63e542b16d5&country=ES&year=2020`);
